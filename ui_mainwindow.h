...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        startBtn->setGeometry(QRect(300, 290, 75, 23));
        logTextBrowser = new QTextBrowser(centralWidget);
        logTextBrowser->setObjectName(QStringLiteral("logTextBrowser"));
        logTextBrowser->setGeometry(QRect(10, 360, 691, 171));
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(300, 330, 81, 20));
        ...
        groupBox_2->setGeometry(QRect(20, 110, 691, 61));
        ...
        groupBox_3->setGeometry(QRect(20, 190, 691, 81));
